  ...
  <body class="bg-light">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md order-md-1">
          <form  action="updatephim1.php?id=<?= $_GET['id']?>"method="POST" enctype="multipart/form-data">
	...
	<div class="dropdown">
		...
		<option value="4">Em Ơi Lên Phố</option>
            ...
            <hr class="mb-4"><br>
            <button class="btn btn-primary btn-lg btn-block" type="submit" name="submit">Edit</button>
          </form>
        </div>
      </div>
